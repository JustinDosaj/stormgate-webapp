...
export function PostCard({ post }: PostCardProps) {
    return (
        <Link key={post.slug} href={`/explore/post/${post.slug}`}>
            <div className="bg-gray-800 hover:bg-gray-900 p-4 rounded-lg shadow-md border border-gray-800 hover:shadow-xl transition-shadow duration-200 h-[400px] flex flex-col justify-between">
                ...
                <div className="flex-grow">
                    ...
                    <p className="text-gray-400 mb-4 line-clamp-4">{post.summary}</p>
                </div>
